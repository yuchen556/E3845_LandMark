...
def check_landmark_bios_version(camera):
    ...
    if camera.isOpened():
        ...
        for i in range(1):
            ...
            if return_value == 1:
                ...
                image402_time2 = image402_time1.replace(':', '-')
                print(image402_time2)
                img402_name = 'Check_land_mark_BIOS_Version{}.jpg'.format(image402_time2)
                # cv2.imwrite(img402_name, to_gray)
            else:
                return_value1, img1 = camera.read()
                if return_value1 == 1:
            ...
            image_time2 = image_time1.replace(':', '-')
            print(image_time2)
            img_name = 'BIOS_Version_LandMark_{}.jpg'.format(image_time2)
            print(img_name)
    ...
    if camera.isOpened():
        ...
        for i in range(1):
            ...
            if return_value == 1:
                ...
                image402_time2 = image402_time1.replace(':', '-')
                print(image402_time2)
                img402_name = 'Check_EC_Version{}.jpg'.format(image402_time2)
                # cv2.imwrite(img402_name, to_gray)
            else:
                return_value1, img1 = camera.read()
                if return_value1 == 1:
            ...
            to_gray_1 = to_gray[310:420, 730:1150]
            # cv2.imshow("EE1", to_gray_1)
            # cv2.waitKey()
            ...
            image_time2 = image_time1.replace(':', '-')
            print(image_time2)
            img_name = 'EC_Version_Hydra_{}.jpg'.format(image_time2)
            print(img_name)
            ...
            if "131" in string:
                BIOS_upgrade_result = True
                print(string)
                logging.debug(':EC_version:{}!'.format(string))
                print("Upgrade_EC_successfully")
            else:
                BIOS_upgrade_result = False
                print(string)
                logging.debug(':EC_version:{}!'.format(string))
                print("Error: EC_is_not_correct.")
            # fullstring = string
            # substring = "过当前页面"
            #
            # if substring in fullstring:
...
def capture_usb_line(camera):
    ...
    if camera.isOpened():
        for i in range(1):
            ...
            image2_time2 = image2_time1.replace(':', '-')
            print(image2_time2)
            img2_name = 'USB_Line_Screen_{}.jpg'.format(image2_time2)
...
def capture_dos(camera):
    ...
    if camera.isOpened():
        for i in range(1):
            ...
            t, T_threshold = cv2.threshold(gray, 12, 255, cv2.THRESH_BINARY_INV)
            # 抽取图像中的行、列（行从220 到500， 列从260 到700）（具体可参考 P29 《OpenCV 轻松入门面向Python》）
            T1_threshold = T_threshold[1:80, 1:335]
            # cv2.imshow("EE1", T1_threshold)
            # cv2.waitKey()
            ...
            image2_time2 = image2_time1.replace(':', '-')
            print(image2_time2)
            img2_name = 'Free_DOS_{}.jpg'.format(image2_time2)
...
# Zhen = initial_camera()
# Zhen5 = check_landmark_bios_version(Zhen)
# print(Zhen5)


# Zhen = initial_camera()
# Zhen4 = check_ec_version(Zhen)
# print(Zhen4)
